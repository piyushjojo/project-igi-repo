...
public class OrderService implements IOrderService {
	...
	public OrderMedicineResponseDTO fetchOMRSD(Order order) {
		OrderMedicineResponseDTO omrsd = new OrderMedicineResponseDTO(medOrdRepo.findByOrder(order),
				orderRepo.findById(order.getId()).orElseThrow(() -> new ResourceNotFoundException("Not valid")));
		System.out.println("------------------------------------------");
	...
	public OrderMedicineResponseDTO paymentUpdateDetails(PaymentProcessingDto paymentDto, long id) {
		...
		Order order = orderRepo.findById(paymentDto.getOrderId())
				.orElseThrow(() -> new ResourceNotFoundException("Not valid"));
